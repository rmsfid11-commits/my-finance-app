    ...
    <div className="space-y-4 animate-slide">
      ...
      <div className="glass rounded-3xl overflow-hidden">
        {sections.map(({ id, label, Icon, desc }, idx) => (
          <button key={id} onClick={() => setActiveSection(activeSection === id ? null : id)} className={`w-full flex items-center gap-3 p-4 text-left transition-all ${idx < sections.length - 1 ? 'border-b border-c-border' : ''} ${activeSection === id ? 'bg-[#3182F6]/5' : 'hover:bg-c-subtle'}`}>
      ...
      {activeSection === 'profile' && (
        <div className="glass rounded-3xl p-5 space-y-3 animate-fade"><h3 className="font-bold text-sm text-c-text">프로필 설정</h3>
      ...
      {activeSection === 'goals' && (
        <div className="glass rounded-3xl p-5 space-y-3 animate-fade"><h3 className="font-bold text-sm text-c-text">목표 설정</h3>
      ...
      {activeSection === 'budget' && (
        <div className="glass rounded-3xl p-5 space-y-3 animate-fade"><h3 className="font-bold text-sm text-c-text">카테고리별 월 예산</h3>
      ...
      {activeSection === 'notifications' && (
        <div className="glass rounded-3xl p-5 space-y-3 animate-fade"><h3 className="font-bold text-sm text-c-text">알림 설정</h3>
      ...
      {activeSection === 'data' && (
        <div className="glass rounded-3xl p-5 space-y-3 animate-fade"><h3 className="font-bold text-sm text-c-text">데이터 관리</h3>
